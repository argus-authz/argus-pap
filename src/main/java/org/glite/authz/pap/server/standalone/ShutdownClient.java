...
public class ShutdownClient {
  ...
  static void doShutdown() {
    ...
    String shutdownCommand =
        conf.getString(PAPConfiguration.STANDALONE_SERVICE_STANZA + ".shutdown_command");
    ...
    if (shutdownCommand != null) {
      get.setRequestHeader(
          new Header(ShutdownServlet.SHUTDOWN_COMMAND_HEADER_NAME, shutdownCommand));
    }
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      System.err.println(
          "Error reading PAP configuration. Is the PAP_HOME system property/environment variable set correctly?");
