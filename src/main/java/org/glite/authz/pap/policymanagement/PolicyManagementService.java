...
public interface PolicyManagementService {
    ...
    public abstract void removePolicy(String policyId) throws java.rmi.RemoteException;

    public abstract void removePolicySet(String policySetId) throws java.rmi.RemoteException;

    public abstract String storePolicy(String idPrefix, PolicyType policy) throws java.rmi.RemoteException;

    public abstract String storePolicySet(String idPrefix, PolicySetType policySet) throws java.rmi.RemoteException;
