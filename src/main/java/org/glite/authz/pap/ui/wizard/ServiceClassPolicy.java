...
public class ServiceClassPolicy extends PolicyWizard {
	...
	public static PolicyType build(List<AttributeWizard> targetAttributeList,
		...
		return PolicyWizard.build(generateServiceClassPolicyId(), targetAttributeList, exceptionsAttributeList, effect);
	}
	...
	public ServiceClassPolicy(List<AttributeWizard> targetAttributeList, List<List<AttributeWizard>> exceptionsAttributeList, EffectType effect) {
