...
public class RefreshCache extends PAPManagementCLI {
	...
	private static final String DESCRIPTION = "Invalidate the cache and retrieve remote policies now."
			+ " Without arguments refresh the cache of all the trusted PAPs.";
