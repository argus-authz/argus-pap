...
public class AttributeWizard {
	...
	DN("dn", "DN", DataType.STRING, Category.SUBJECT), FQAN("fqan", "FQAN",
		DataType.STRING, Category.SUBJECT), GA("ga", "GA",
		DataType.STRING, Category.SUBJECT), RESOURCE_URI(
		"resource_uri", "RESOURCE_URI", DataType.STRING,
		Category.RESOURCE), SERVICE_CLASS("service_class",
		"SERVICE_CLASS", DataType.STRING, Category.RESOURCE);
	// PILOT
	...
	private Attribute(String id, String xacmlId, String dataType,
		Category category) {
	    this.id = id;
	...
	attribute.getAttributeValues()
		.add(CtxAttributeValueHelper.build(value));
	return attribute;
    }
