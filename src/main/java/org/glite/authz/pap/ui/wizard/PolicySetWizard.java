...
public abstract class PolicySetWizard {
    ...
    protected PolicySetWizard(String policySetId,
	...
	if ((target == null) && (obligations == null)) {
	    policySet = PolicySetHelper.buildWithAnyTarget(policySetId,
		    policyCombiningAlgorithmId);
	} else {
	    policySet = PolicySetHelper.build(policySetId,
		    policyCombiningAlgorithmId, target, obligations);
	}
	...
	PolicySetHelper.addPolicySetReference(this.policySet, policySetT
		.getPolicySetId());
