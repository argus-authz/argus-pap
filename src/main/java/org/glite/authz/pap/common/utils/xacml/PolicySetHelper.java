...
public class PolicySetHelper extends XACMLHelper<PolicySetType> {
    ...
    public static void addPolicy(PolicySetType policySet, int index,
	    PolicyType policy) {
	...
	policySet.getPolicyIdReferences().add(
		...
		IdReferenceHelper.build(
			IdReferenceHelper.Type.POLICY_ID_REFERENCE, idValue));
    }
    ...
    public static void addPolicySet(PolicySetType policySet, int index,
	    PolicySetType childPolicySet) {
	policySet.getPolicySets().add(index, childPolicySet);
    }

    public static void addPolicySet(PolicySetType policySet,
	    PolicySetType childPolicySet) {
    ...
    public static PolicySetType build(String policySetId,
	    String policyCombiningAlgorithmId, TargetType target,
    ...
    private static List<XACMLObject> getChildrenOrderedList(
    ...
    public static List<String> getPolicySetIdReferencesValues(
	    PolicySetType policySet) {
    ...
    private static boolean idIsContainedInList(String id,
	    List<IdReferenceType> list) {
    ...
    public static boolean policyReferenceIdExists(PolicySetType policySet,
	    String id) {
	return idIsContainedInList(id, policySet.getPolicyIdReferences());
    }

    public static boolean policySetReferenceIdExists(PolicySetType policySet,
	    String id) {
