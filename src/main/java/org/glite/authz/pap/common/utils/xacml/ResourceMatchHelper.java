...
public class ResourceMatchHelper extends XACMLHelper<ResourceMatchType> {
	...
	public static ResourceMatchType build() {
		return (ResourceMatchType) Configuration.getBuilderFactory().getBuilder(
				ResourceMatchType.DEFAULT_ELEMENT_NAME).buildObject(
	...
	public static List<ResourceMatchType> buildListWithDesignator(List<AttributeType> attributeList, String matchFunctionId) {
