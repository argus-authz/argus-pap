...
public class IdReferenceHelper extends XACMLHelper<IdReferenceType> {
	...
	public static boolean isPolicyIdReference(IdReferenceType idReference) {
		if (idReference.getElementQName().equals(IdReferenceType.POLICY_ID_REFERENCE_ELEMENT_NAME)) {
			return true;
		}
		return false;
	}
	...
	public static boolean isPolicySetIdReference(IdReferenceType idReference) {
		if (idReference.getElementQName().equals(IdReferenceType.POLICY_SET_ID_REFERENCE_ELEMENT_NAME)) {
			return true;
		}
		return false;
	}
